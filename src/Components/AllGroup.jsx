...
const AllGroup = () => {
  ...
  return (
    <div className="min-h-screen px-6 py-16 flex flex-col items-center transition-colors duration-300">
  ...
  <div className="w-full max-w-7xl">
    {!grouped.length ? (
      ...
      grouped.map((group, i) => (
        <div key={i} className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 mb-10">
          {group.map(a => (
            <article
              key={a._id}
              className="bg-white dark:bg-gray-800 rounded-2xl shadow-md hover:shadow-xl border border-gray-200 dark:border-gray-700 hover:border-blue-500 dark:hover:border-blue-400 transform hover:-translate-y-2 transition-all duration-300 flex flex-col overflow-hidden"
            >
